...
const CACHE_VERSION = "finance-v2-20260822-talaan-r3";
...
const APP_SHELL = [
  ...
  asset("./version.json"),
  asset("./app.css?v=2.0.1-talaan3"),
  asset("./shell-ui.css?v=2.0.1-talaan3"),
  asset("./dashboard-interactions.css?v=2.0.1-talaan3"),
  asset("./ui-icon-alignment.css?v=2.0.1-talaan3"),
  asset("./black-canvas.css?v=2.0.1-talaan3"),
  asset("./desktop-ui-phase1.css?v=2.0.1-talaan3"),
  asset("./desktop-ux.css?v=2.0.1-talaan3"),
  asset("./production-ui-audit.css?v=2.0.1-talaan3"),
  asset("./summary-mascots.css?v=2.0.1-talaan3"),
  asset("./form-inputs.js?v=2.0.1-talaan3"),
  asset("./application-help.js?v=2.0.1-talaan3"),
  asset("./pwa-update.js?v=2.0.1-talaan3"),
  asset("./brand-icons.js?v=2.0.1-talaan3"),
  asset("./phone-finance-compat.js?v=2.0.1-talaan3"),
  asset("./summary-mascots.js?v=2.0.1-talaan3"),
  asset("./cash-flow-summary.js?v=2.0.1-talaan3"),
  asset("./header-tools-compat.js?v=2.0.1-talaan3"),
  asset("./dashboard-interactions-core.css?v=2.0.1-talaan3"),
  asset("./liquid-glass.css?v=2.0.1-talaan3"),
  asset("./mobile.css?v=2.0.1-talaan3"),
  asset("./interaction-patterns.js?v=2.0.1-talaan3"),
  asset("./privacy-lock.js?v=2.0.1-talaan3"),
  asset("./security-profiles.js?v=2.0.1-talaan3"),
  asset("./security-profiles.css?v=2.0.1-talaan3"),
  asset("./cloud-conflict-review.js?v=2.0.1-talaan3"),
  asset("./cloud-conflict-resolution.js?v=2.0.1-talaan3"),
  asset("./cloud-sync-lifecycle.js?v=2.0.1-talaan3"),
  asset("./cloud-sync.js?v=2.0.1-talaan3"),
  asset("./account-ledger.js?v=2.0.1-talaan3"),
  asset("./account-ledger.css?v=2.0.1-talaan3"),
  asset("./budget-planning.js?v=2.0.1-talaan3"),
  asset("./budget-planning.css?v=2.0.1-talaan3"),
  asset("./reports-insights.js?v=2.0.1-talaan3"),
  asset("./reports-insights.css?v=2.0.1-talaan3"),
  asset("./productivity-tools.js?v=2.0.1-talaan3"),
  asset("./productivity-tools.css?v=2.0.1-talaan3"),
  asset("./reminders-alerts.js?v=2.0.1-talaan3"),
  asset("./reminders-alerts.css?v=2.0.1-talaan3"),
  asset("./projects-calendar.js?v=2.0.1-talaan3"),
  asset("./projects-calendar.css?v=2.0.1-talaan3"),
  asset("./sync-config.js?v=2.0.1-talaan3"),
  asset("./sync-runtime-compat.js?v=2.0.1-talaan3"),
  asset("./expense-screenshot-parser.js?v=2.0.1-talaan3"),
  asset("./expense-screenshot-detect.js?v=2.0.1-talaan3"),
  asset("./expense-screenshot-ai.js?v=2.0.1-talaan3"),
  ...
  asset("./assets/mascots/mascot-red.png?v=2.0.1-talaan3"),
  asset("./assets/mascots/mascot-green.png?v=2.0.1-talaan3"),
  asset("./assets/mascots/mascot-blue.png?v=2.0.1-talaan3"),
  asset("./assets/mascots/mascot-orange.png?v=2.0.1-talaan3")
];
