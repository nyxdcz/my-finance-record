...
const CACHE_VERSION = "finance-v15-20260820-shell-ui-r47";
...
const APP_SHELL = [
  ...
  asset("./pwa-update-v15-0-5.js?v=15.2.11-release7"),
  ...
  asset("./sync-runtime-compat.js?v=15.2.11-release2"),
