...
const CACHE_VERSION = "finance-v15-20260819-form-inputs-r41";
...
const APP_SHELL = [
  ...
  asset("./pwa-update-v15-0-5.js?v=15.2.6-release1"),
  ...
  asset("./sync-config.js?v=15.2.6-release1"),
