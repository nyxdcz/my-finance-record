...
const APP_SHELL = [
  ...
  asset("./cloud-sync-lifecycle.js?v=2.5.0-account-integrity2"),
  asset("./cloud-sync.js?v=2.5.0-account-integrity2"),
  asset("./account-ledger.js?v=2.5.0-account-integrity2"),
  asset("./account-submit-compat.js?v=2.5.0-account-integrity2"),
