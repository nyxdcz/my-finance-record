...
const CACHE_VERSION = "finance-v15-20260820-auth-sync-r48";
...
const APP_SHELL = [
  ...
  asset("./pwa-update-v15-0-5.js?v=15.2.12-release8"),
  ...
  asset("./sync-runtime-compat.js?v=15.2.12-release3"),
