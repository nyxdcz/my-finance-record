...
const CACHE_VERSION = "finance-v15-20260821-production-audit-r52";
...
const APP_SHELL = [
  ...
  asset("./pwa-update-v15-0-5.js?v=15.2.16-release12"),
  ...
  asset("./sync-runtime-compat.js?v=15.2.16-release7"),
