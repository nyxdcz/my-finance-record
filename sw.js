...
const CACHE_VERSION = "finance-v15-20260821-runtime-stable-audit-r53";
...
const APP_SHELL = [
  ...
  asset("./pwa-update-v15-0-5.js?v=15.2.17-release13"),
  ...
  asset("./sync-runtime-compat.js?v=15.2.17-release8"),
