...
const CACHE_VERSION = "finance-v15-20260818-disclosure-alignment-r40";
...
const APP_SHELL = [
  ...
  asset("./pwa-update-v15-0-5.js?v=15.2.5-release1"),
  ...
  asset("./sync-config.js?v=15.2.5-release1"),
