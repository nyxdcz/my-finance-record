...
const APP_SHELL = [
  ...
  asset("./desktop-ux-v15-2-0.css?v=15.2.4-header1"),
  asset("./pwa-update-v15-0-5.js?v=15.2.4-release1"),
  ...
  asset("./sync-config.js?v=15.2.4-release1"),
