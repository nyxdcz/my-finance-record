...
const CACHE_VERSION = "finance-v2-20260828-household-splits-r11";
...
const APP_SHELL = [
  ...
  asset("./cloud-sync-lifecycle.js?v=2.5.0-talaan1"),
  asset("./cloud-sync.js?v=2.5.0-talaan1"),
  asset("./account-ledger.js?v=2.5.0-talaan1"),
  ...
  asset("./expense-screenshot-parser.js?v=2.5.0-talaan1"),
  asset("./expense-screenshot-detect.js?v=2.5.0-talaan1"),
  asset("./expense-screenshot-ai.js?v=2.5.0-talaan1"),
