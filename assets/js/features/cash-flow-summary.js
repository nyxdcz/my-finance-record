...
(function installIncomeExpensesDashboard(root) {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .income-expenses-range{display:grid;grid-template-columns:repeat(4,minmax(48px,auto));border:1px solid var(--line);border-radius:var(--talaan-control-radius);background:var(--surface);overflow:hidden}.income-expenses-range button{min-width:48px;min-height:38px;padding:7px 11px;border:0;border-inline-end:1px solid var(--line);background:transparent;color:var(--muted);font:inherit;font-size:.68rem;font-weight:800}.income-expenses-range button:last-child{border-inline-end:0}.income-expenses-range button[aria-pressed="true"]{background:var(--primary);color:var(--primary-contrast,#fff)}
      .income-expenses-summary,.income-expenses-chart-card,.income-expenses-lower-card{border:1px solid var(--line);border-radius:var(--talaan-card-radius);background:var(--surface);box-shadow:0 2px 7px rgba(15,23,42,.055)}
