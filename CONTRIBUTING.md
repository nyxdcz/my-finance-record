...
3. Create and push an annotated tag matching `package.json`, for example `git tag -a v14.0.5 -m "My Finance Records v14.0.5"` followed by `git push origin v14.0.5`.
