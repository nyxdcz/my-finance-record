# Security Policy · Talaan V2.0.1

**Talaan V2.0.1** is the current production release. Security changes must preserve the local-first finance model, Finance Schema 12, Cloud Schema V3, encrypted synchronization, recovery paths, and installed-PWA compatibility unless a reviewed migration explicitly changes one of those contracts.

## Current security baseline

- **Product:** Talaan.
- **Current product release:** V2.0.1.
- **Finance Schema:** 12.
- **Cloud Schema:** V3.
...
All security fixes and releases continue forward from the current Talaan V2.0.1 baseline using semantic versioning.
...
See [`CONTRIBUTING.md`](CONTRIBUTING.md) for the contribution and release process, [`PRIVACY.md`](PRIVACY.md) for privacy boundaries, and [`CHANGELOG.md`](CHANGELOG.md) for the current Talaan V2.0.1 release notes.
