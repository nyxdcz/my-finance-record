...
if (pkg.version !== "15.2.16") fail(`Expected current package version 15.2.16, found ${pkg.version || "(missing)"}`);
if (!read("README.md").startsWith("# My Finance Records · V15.2.16")) fail("README release heading is not V15.2.16");
if (!read("CHANGELOG.md").startsWith("## 15.2.16 · 2026-08-21")) fail("CHANGELOG latest entry is not V15.2.16");
...
console.log("Repository inspection passed: V15.2.16 release sources, local paths, deploy paths, package metadata, permissions, and public sync configuration are consistent.");
