...
assert.match(worker, /finance-v15-20260820-sidebar-icons-r46/, "PWA cache must match the V15.2.9 Application Help extraction shell");
...
assert.equal(pkg.version, "15.2.10");
