...
assert.match(worker, /finance-v15-20260820-ui-asset-delivery-r45/, "PWA cache must match the V15.2.9 Application Help extraction shell");
...
assert.equal(pkg.version, "15.2.9");
console.log("Record spending regression validation passed under V15.2.9.");
