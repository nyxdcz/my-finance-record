...
assert.match(worker, /finance-v15-20260819-pwa-ui-ownership-r44/, "PWA cache must match the V15.2.8 Application Help extraction shell");
...
assert.equal(pkg.version, "15.2.8");
console.log("Record spending regression validation passed under V15.2.8.");
