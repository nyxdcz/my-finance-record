...
assert.match(worker, /finance-v15-20260819-sync-config-separation-r43/, "PWA cache must match the V15.2.7 Application Help extraction shell");
...
assert.equal(pkg.version, "15.2.7");
console.log("Record spending regression validation passed under V15.2.7.");
