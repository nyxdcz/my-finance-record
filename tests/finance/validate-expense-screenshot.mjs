...
assert.match(runtimeCompat, /expense-screenshot-parser\.js\?v=2\.0\.1-talaan5/, "screenshot parser should use the current Talaan runtime query");
assert.match(runtimeCompat, /expense-screenshot-detect\.js\?v=2\.0\.1-talaan5/, "local screenshot detector should use the current Talaan runtime query");
assert.match(runtimeCompat, /expense-screenshot-ai\.js\?v=2\.0\.1-talaan5/, "optional AI screenshot detector should use the current Talaan runtime query");
...
assert.match(worker, /expense-screenshot-parser\.js\?v=2\.0\.1-talaan5/, "service worker should precache the screenshot parser on the current query");
assert.match(worker, /expense-screenshot-detect\.js\?v=2\.0\.1-talaan5/, "service worker should precache the local screenshot detector on the current query");
assert.match(worker, /expense-screenshot-ai\.js\?v=2\.0\.1-talaan5/, "service worker should precache the optional AI client on the current query");
