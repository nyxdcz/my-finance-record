...
assert.match(worker, /finance-v15-20260821-runtime-stable-audit-r53/, "service worker cache generation must match V15.2.17 while preserving screenshot detection");
