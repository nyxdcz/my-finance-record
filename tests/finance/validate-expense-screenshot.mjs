...
assert.match(worker, /finance-v15-20260820-production-ui-audit-r49/, "service worker cache generation must match V15.2.13 while preserving screenshot detection");
