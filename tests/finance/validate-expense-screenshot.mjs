...
assert.match(worker, /finance-v15-20260821-production-audit-r52/, "service worker cache generation must match V15.2.16 while preserving screenshot detection");
