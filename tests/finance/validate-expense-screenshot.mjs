...
assert.match(worker, /finance-v15-20260820-ui-asset-delivery-r45/, "service worker cache generation must match V15.2.9 while preserving screenshot detection");
