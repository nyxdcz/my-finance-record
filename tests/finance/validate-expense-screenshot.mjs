...
assert.match(worker, /finance-v15-20260821-monthly-repeat-class-r58/, "service worker cache generation must match V15.2.18 while preserving screenshot detection");
