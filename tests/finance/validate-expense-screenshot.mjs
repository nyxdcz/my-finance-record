...
assert.ok(worker.includes(version.cacheVersion), "service worker cache generation must match V2.0.0 while preserving screenshot detection");
...
console.log("Expense screenshot local and optional AI detector validation passed under the V2.0.0 release shell.");
