...
assert.match(worker, /finance-v15-20260820-structured-project-drag-r51/, "service worker cache generation must match V15.2.15 while preserving screenshot detection");
...
console.log("Expense screenshot local and optional AI detector validation passed under the V15.2.9 release shell.");
