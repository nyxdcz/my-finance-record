...
const required = [
  [version.version === "15.2.11", "current release is V15.2.11"],
  [version.cacheVersion === "finance-v15-20260820-shell-ui-r47", "r47 cache is active"],
...
console.log("V15.2.6 form-input extraction source contract passed under the V15.2.11 shell");
