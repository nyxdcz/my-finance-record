...
const required = [
  [version.version === "15.2.8", "current release is V15.2.8"],
  [version.cacheVersion === "finance-v15-20260819-pwa-ui-ownership-r44", "r42 cache is active"],
...
console.log("V15.2.6 form-input extraction source contract passed under the V15.2.8 shell");
