...
const required = [
  [version.version === "15.2.15", "current release is V15.2.15"],
  [version.cacheVersion === "finance-v15-20260820-structured-project-drag-r51", "r50 cache is active"],
...
console.log("V15.2.6 form-input extraction source contract passed under the V15.2.15 shell");
