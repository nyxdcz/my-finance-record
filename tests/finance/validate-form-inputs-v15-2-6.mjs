...
const required = [
  [version.version === "2.0.0", "current release is V2.0.0"],
  [version.cacheVersion === "finance-v2-20260822-organized-complete-r1", "V2.0.0 cache is active"],
...
console.log("V15.2.6 form-input extraction source contract passed under the V2.0.0 organized shell");
