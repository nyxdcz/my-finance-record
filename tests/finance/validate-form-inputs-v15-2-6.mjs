...
const required = [
  [version.version === "15.2.24", "current release is V15.2.24"],
  [version.cacheVersion === "finance-v15-20260822-compact-expense-collapse-r60", "V15.2.24 cache is active"],
...
console.log("V15.2.6 form-input extraction source contract passed under the V15.2.24 shell");
