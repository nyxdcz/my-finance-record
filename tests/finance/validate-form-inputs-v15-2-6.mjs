...
const required = [
  [version.version === "15.2.16", "current release is V15.2.16"],
  [version.cacheVersion === "finance-v15-20260821-production-audit-r52", "r50 cache is active"],
...
console.log("V15.2.6 form-input extraction source contract passed under the V15.2.16 shell");
