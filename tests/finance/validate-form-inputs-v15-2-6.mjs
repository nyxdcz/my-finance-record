...
const required = [
  [version.version === "15.2.17", "current release is V15.2.17"],
  [version.cacheVersion === "finance-v15-20260821-runtime-stable-audit-r53", "r50 cache is active"],
...
console.log("V15.2.6 form-input extraction source contract passed under the V15.2.17 shell");
