...
const required = [
  [version.version === "15.2.14", "current release is V15.2.14"],
  [version.cacheVersion === "finance-v15-20260820-common-desktop-r50", "r50 cache is active"],
...
console.log("V15.2.6 form-input extraction source contract passed under the V15.2.14 shell");
