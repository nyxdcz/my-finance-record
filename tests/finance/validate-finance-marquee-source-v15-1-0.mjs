...
const expectedVersion = "15.2.20";
const expectedIndexCache = "finance-v15-20260821-compact-expense-stability-r56";
...
console.log("Finance marquee source layout and V15.2.20 PWA cache metadata validated.");
