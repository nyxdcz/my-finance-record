...
const expectedVersion = "15.2.7";
const expectedIndexCache = "finance-v15-20260819-sync-config-separation-r43";
...
console.log("Finance marquee source layout and V15.2.7 PWA cache metadata validated.");
