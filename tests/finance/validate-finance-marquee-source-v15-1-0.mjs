...
const expectedIndexCache = version.cacheVersion;
const expectedCache = version.cacheVersion;
...
console.log(`Finance marquee source layout and ${expectedVersion} PWA cache metadata validated.`);
