...
const expectedVersion = "15.2.8";
const expectedIndexCache = "finance-v15-20260819-pwa-ui-ownership-r44";
...
console.log("Finance marquee source layout and V15.2.8 PWA cache metadata validated.");
