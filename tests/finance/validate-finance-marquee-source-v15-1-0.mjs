...
const expectedVersion = "15.2.24";
const expectedIndexCache = "finance-v15-20260822-compact-expense-collapse-r60";
...
console.log("Finance marquee source layout and V15.2.24 PWA cache metadata validated.");
