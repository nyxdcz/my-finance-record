...
const expectedVersion = "15.2.21";
const expectedIndexCache = "finance-v15-20260821-monthly-repeat-label-r57";
...
console.log("Finance marquee source layout and V15.2.21 PWA cache metadata validated.");
