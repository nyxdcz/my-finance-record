...
assert.match(index, /ui-icon-alignment-v15-0-5\.css\?v=15\.2\.4-ui1/);
assert.equal(version.cacheVersion, "finance-v15-20260818-disclosure-alignment-r40");
assert.match(sw, /finance-v15-20260818-disclosure-alignment-r40/);
console.log("V15.2.5 header UI regression passed while preserving the V15.2.4 icon-alignment asset pin.");
