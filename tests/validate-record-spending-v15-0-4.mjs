...
assert.match(worker, /finance-v15-20260818-ui-refinement-r39/, "PWA cache must match the V15.2.4 sync-status refresh shell");
...
assert.equal(pkg.version, "15.2.4");
console.log("Record spending regression validation passed under V15.2.4.");
