...
assert.match(worker, /finance-v15-20260817-phone-finance-r37/, "PWA cache must match the V15.2.2 phone-Finance/cloud-profile refresh shell");
...
console.log("Record spending regression validation passed under V15.2.2.");
