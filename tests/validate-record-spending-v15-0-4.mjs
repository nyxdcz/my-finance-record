...
assert.match(worker, /finance-v15-20260817-sync-status-r38/, "PWA cache must match the V15.2.3 sync-status refresh shell");
...
assert.equal(pkg.version, "15.2.3");
console.log("Record spending regression validation passed under V15.2.3.");
