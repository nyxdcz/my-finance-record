...
assert.match(worker, /finance-v15-20260816-desktop-ux-quick-wins-r30/, "PWA cache must match the V15.2.1 shell");
...
assert.equal(pkg.version, "15.2.1");
console.log("Record spending regression validation passed under V15.2.1.");
