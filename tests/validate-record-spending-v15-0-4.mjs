...
assert.match(worker, /finance-v15-20260819-form-inputs-r41/, "PWA cache must match the V15.2.6 form-input extraction shell");
...
assert.equal(pkg.version, "15.2.6");
console.log("Record spending regression validation passed under V15.2.6.");
