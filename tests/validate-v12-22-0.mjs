...
assert(["12.22.0","12.23.0","12.24.0","12.25.0"].includes(version.version),"version.json is not a supported V12.22+ release");
...
assert(["node tests/validate-v12-22-0.mjs","node tests/validate-v12-23-0.mjs","node tests/validate-v12-24-0.mjs","node tests/validate-v12-25-0.mjs"].includes(packageJson.scripts?.quality),"quality script mismatch");
