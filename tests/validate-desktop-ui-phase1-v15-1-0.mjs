...
if (version.cacheVersion !== "finance-v15-20260818-ui-refinement-r39") fail(`Unexpected cache version: ${version.cacheVersion}`);
if (!worker.includes('const CACHE_VERSION = "finance-v15-20260818-ui-refinement-r39";')) fail("Service worker cache version is not the V15.2.2 phone-Finance/cloud-profile refresh cache.");
