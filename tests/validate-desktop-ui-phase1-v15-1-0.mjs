...
if (version.cacheVersion !== "finance-v15-20260816-sidebar-brand-r35") fail(`Unexpected cache version: ${version.cacheVersion}`);
if (!worker.includes('const CACHE_VERSION = "finance-v15-20260816-sidebar-brand-r35";')) fail("Service worker cache version is not the V15.2.2 sidebar-brand refresh cache.");
...
console.log("Desktop UI Phase 1 validation passed under V15.2.2: desktop hierarchy, compact Income, report export menu, calendar states, Settings disclosure, contextual Paid note, deployment packaging, and sidebar-brand PWA delivery are source-aligned.");
