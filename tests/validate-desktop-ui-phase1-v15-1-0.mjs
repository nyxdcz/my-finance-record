...
if (version.cacheVersion !== "finance-v15-20260817-sync-status-r38") fail(`Unexpected cache version: ${version.cacheVersion}`);
if (!worker.includes('const CACHE_VERSION = "finance-v15-20260817-sync-status-r38";')) fail("Service worker cache version is not the V15.2.2 phone-Finance/cloud-profile refresh cache.");
