...
if (version.cacheVersion !== "finance-v15-20260815-desktop-ui-phase1-r28") fail(`Unexpected cache version: ${version.cacheVersion}`);
if (!worker.includes('const CACHE_VERSION = "finance-v15-20260815-desktop-ui-phase1-r28";')) fail("Service worker cache version is not desktop-ui-phase1-r28.");
...
if (!html.includes('id="settingsOverviewAppStatus">Version 15.1.0</strong>')) fail("Settings overview starts with a stale app version.");
...
console.log("Desktop UI Phase 1 validation passed: desktop-only hierarchy, compact Income, report export menu, calendar states, Settings disclosure, contextual Paid note, deployment packaging, and r28 PWA delivery are source-aligned.");
