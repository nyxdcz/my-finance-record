...
if (version.cacheVersion !== "finance-v15-20260816-desktop-ux-quick-wins-r30") fail(`Unexpected cache version: ${version.cacheVersion}`);
if (!worker.includes('const CACHE_VERSION = "finance-v15-20260816-desktop-ux-quick-wins-r30";')) fail("Service worker cache version is not V15.2.1 desktop UX r29.");
...
console.log("Desktop UI Phase 1 validation passed under V15.2.1: desktop hierarchy, compact Income, report export menu, calendar states, Settings disclosure, contextual Paid note, deployment packaging, and r29 PWA delivery are source-aligned.");
