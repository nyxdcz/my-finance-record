...
if (version.cacheVersion !== "finance-v15-20260817-phone-finance-r37") fail(`Unexpected cache version: ${version.cacheVersion}`);
if (!worker.includes('const CACHE_VERSION = "finance-v15-20260817-phone-finance-r37";')) fail("Service worker cache version is not the V15.2.2 phone-Finance/cloud-profile refresh cache.");
...
console.log("Desktop UI Phase 1 validation passed under V15.2.2: desktop hierarchy, compact Income, report export menu, calendar states, Settings disclosure, contextual Paid note, deployment packaging, and phone-Finance/cloud-profile PWA delivery are source-aligned.");
