...
assert(worker.includes('finance-v15-20260820-production-ui-audit-r49'), "PWA cache was not rotated for the V15.2.13 production UI audit");
...
console.log("Safe multi-device sync validation passed under the V15.2.13 release shell.");
