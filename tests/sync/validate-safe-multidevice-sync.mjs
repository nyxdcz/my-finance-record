...
assert(worker.includes('finance-v15-20260819-pwa-ui-ownership-r44'), "PWA cache was not rotated for the V15.2.8 Application Help extraction shell");
...
console.log("Safe multi-device sync validation passed under the V15.2.8 release shell.");
