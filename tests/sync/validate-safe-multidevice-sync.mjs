...
assert(worker.includes('finance-v15-20260820-common-desktop-r50'), "PWA cache was not rotated for the V15.2.14 production UI audit");
...
console.log("Safe multi-device sync validation passed under the V15.2.14 release shell.");
