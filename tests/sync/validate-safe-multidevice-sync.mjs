...
assert(worker.includes('finance-v15-20260819-sync-config-separation-r43'), "PWA cache was not rotated for the V15.2.7 Application Help extraction shell");
...
console.log("Safe multi-device sync validation passed under the V15.2.7 release shell.");
