...
test("Talaan V2.4.0 release metadata is visible", async ({ page }) => {
  await page.goto("http://127.0.0.1:3000/index.html?page=dashboard", { waitUntil:"networkidle" });
  await expect(page).toHaveTitle(/Talaan · V2\.4\.0/);
  await expect(page.locator("#buildBadge")).toContainText("V2.4.0");
});
