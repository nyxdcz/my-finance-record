...
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=15.2.10-priority4a1");
...
const expectedCache = "finance-v15-20260820-sidebar-icons-r46";
if (version.version !== "15.2.10") throw new Error(`Unexpected app version: ${version.version}`);
...
if (!serviceWorker.includes("./sync-runtime-compat.js?v=15.2.10-priority4a1")) throw new Error("Service worker must precache the sync runtime compatibility file.");
