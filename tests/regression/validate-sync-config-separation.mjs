...
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=15.2.14-release5");
...
const expectedCache = "finance-v15-20260820-common-desktop-r50";
if (version.version !== "15.2.14") throw new Error(`Unexpected app version: ${version.version}`);
...
if (!serviceWorker.includes("./sync-runtime-compat.js?v=15.2.14-release5")) throw new Error("Service worker must precache the sync runtime compatibility file.");
