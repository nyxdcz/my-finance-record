...
const configPosition = index.indexOf("./sync-config.js?v=2.5.0-talaan1");
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=2.5.0-talaan1");
...
const expectedCache = "finance-v2-20260828-household-splits-r13";
