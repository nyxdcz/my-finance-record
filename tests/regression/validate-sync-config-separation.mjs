...
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=15.2.11-release2");
...
const expectedCache = "finance-v15-20260820-shell-ui-r47";
if (version.version !== "15.2.11") throw new Error(`Unexpected app version: ${version.version}`);
...
if (!serviceWorker.includes("./sync-runtime-compat.js?v=15.2.11-release2")) throw new Error("Service worker must precache the sync runtime compatibility file.");
