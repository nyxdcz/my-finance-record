...
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=15.2.12-release3");
...
if (version.version !== "15.2.12") throw new Error(`Unexpected app version: ${version.version}`);
...
if (!serviceWorker.includes("./sync-runtime-compat.js?v=15.2.12-release3")) throw new Error("Service worker must precache the sync runtime compatibility file.");
