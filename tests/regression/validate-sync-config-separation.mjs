...
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=15.2.22-release12");
...
const expectedCache = "finance-v15-20260821-monthly-repeat-class-r58";
if (version.version !== "15.2.22") throw new Error(`Unexpected app version: ${version.version}`);
...
if (!serviceWorker.includes("./sync-runtime-compat.js?v=15.2.22-release12")) throw new Error("Service worker must precache the sync runtime compatibility file.");
