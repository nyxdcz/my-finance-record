...
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=15.2.16-release7");
...
const expectedCache = "finance-v15-20260821-production-audit-r52";
if (version.version !== "15.2.16") throw new Error(`Unexpected app version: ${version.version}`);
...
if (!serviceWorker.includes("./sync-runtime-compat.js?v=15.2.16-release7")) throw new Error("Service worker must precache the sync runtime compatibility file.");
