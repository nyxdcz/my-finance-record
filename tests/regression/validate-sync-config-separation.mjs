...
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=15.2.17-release8");
...
const expectedCache = "finance-v15-20260821-runtime-stable-audit-r53";
if (version.version !== "15.2.17") throw new Error(`Unexpected app version: ${version.version}`);
...
if (!serviceWorker.includes("./sync-runtime-compat.js?v=15.2.17-release8")) throw new Error("Service worker must precache the sync runtime compatibility file.");
