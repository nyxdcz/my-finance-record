...
const configPosition = index.indexOf("./sync-config.js?v=2.0.1-talaan5");
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=2.0.1-talaan5");
...
const expectedCache = "finance-v2-20260824-transaction-views-r6";
...
if (!serviceWorker.includes("./sync-config.js?v=2.0.1-talaan5")) throw new Error("Service worker must precache the Talaan sync configuration file.");
if (!serviceWorker.includes("./sync-runtime-compat.js?v=2.0.1-talaan5")) throw new Error("Service worker must precache the Talaan sync runtime compatibility file.");
