...
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=15.2.23-release13");
...
if (version.version !== "15.2.23") throw new Error(`Unexpected app version: ${version.version}`);
...
if (!serviceWorker.includes("./sync-runtime-compat.js?v=15.2.23-release13")) throw new Error("Service worker must precache the sync runtime compatibility file.");
