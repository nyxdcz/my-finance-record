...
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=15.2.15-release6");
...
const expectedCache = "finance-v15-20260820-structured-project-drag-r51";
if (version.version !== "15.2.15") throw new Error(`Unexpected app version: ${version.version}`);
...
if (!serviceWorker.includes("./sync-runtime-compat.js?v=15.2.15-release6")) throw new Error("Service worker must precache the sync runtime compatibility file.");
