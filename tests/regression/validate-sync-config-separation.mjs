...
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=15.2.21-release11");
...
const expectedCache = "finance-v15-20260821-monthly-repeat-label-r57";
if (version.version !== "15.2.21") throw new Error(`Unexpected app version: ${version.version}`);
...
if (!serviceWorker.includes("./sync-runtime-compat.js?v=15.2.21-release11")) throw new Error("Service worker must precache the sync runtime compatibility file.");
