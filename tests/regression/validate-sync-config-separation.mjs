...
const runtimePosition = index.indexOf("./sync-runtime-compat.js?v=15.2.13-release4");
...
if (version.version !== "15.2.13") throw new Error(`Unexpected app version: ${version.version}`);
...
if (!serviceWorker.includes("./sync-runtime-compat.js?v=15.2.13-release4")) throw new Error("Service worker must precache the sync runtime compatibility file.");
