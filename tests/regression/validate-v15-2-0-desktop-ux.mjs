...
const required = [
  [version.version === "15.2.22", "version.json is V15.2.18"],
  [pkg.version === "15.2.22", "package.json is V15.2.18"],
  [version.schemaVersion === 12 && version.cloudSchemaVersion === 3, "schemas remain 12/3"],
  [version.cacheVersion === "finance-v15-20260821-monthly-repeat-class-r58", "V15.2.18 production UI audit cache is declared"],
  [index.includes("My Finance Records · V15.2.22"), "page title is V15.2.18"],
  [changelog.startsWith("## 15.2.22 · 2026-08-21"), "CHANGELOG begins with V15.2.18"],
  ...
  [sw.includes('const APP_VERSION = "15.2.22"') && sw.includes(version.cacheVersion), "service worker delivery matches release"],
  [sw.includes("desktop-ux-v15-2-0.css?v=15.2.5-disclosure1"), "desktop disclosure CSS is precached"],
  [runtimeCompat.includes('const VERSION = "15.2.22"') && runtimeCompat.includes('const RELEASE_NAME = "Monthly Repeat Label Isolation"'), "release override matches V15.2.18"],
...
console.log("V15.2.22 release preserves the desktop UX source contract");
