...
const required = [
  [version.version === "15.2.13", "version.json is V15.2.13"],
  [pkg.version === "15.2.13", "package.json is V15.2.13"],
  [version.schemaVersion === 12 && version.cloudSchemaVersion === 3, "schemas remain 12/3"],
  [version.cacheVersion === "finance-v15-20260820-production-ui-audit-r49", "V15.2.13 production UI audit cache is declared"],
  [index.includes("My Finance Records · V15.2.13"), "page title is V15.2.13"],
  [changelog.startsWith("## 15.2.13 · 2026-08-20"), "CHANGELOG begins with V15.2.13"],
  ...
  [sw.includes('const APP_VERSION = "15.2.13"') && sw.includes(version.cacheVersion), "service worker delivery matches release"],
  [sw.includes("desktop-ux-v15-2-0.css?v=15.2.5-disclosure1"), "desktop disclosure CSS is precached"],
  [runtimeCompat.includes('const VERSION = "15.2.13"') && runtimeCompat.includes('const RELEASE_NAME = "Production UI/UX Consistency"'), "release override matches V15.2.13"],
...
console.log("V15.2.13 release preserves the desktop UX source contract");
