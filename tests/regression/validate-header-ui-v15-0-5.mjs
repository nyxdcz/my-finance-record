...
assert.match(sw, /finance-v15-20260819-pwa-ui-ownership-r44/);
console.log("V15.2.8 header UI regression passed while preserving the V15.2.4 icon-alignment asset pin.");
