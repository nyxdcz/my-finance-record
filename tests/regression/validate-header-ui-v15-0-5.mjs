...
assert.match(sw, /finance-v15-20260820-auth-sync-r48/);
console.log("V15.2.9 header UI regression passed while preserving the V15.2.4 icon-alignment asset pin.");
