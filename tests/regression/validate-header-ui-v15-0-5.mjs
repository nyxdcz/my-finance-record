...
assert.match(sw, /finance-v15-20260819-sync-config-separation-r43/);
console.log("V15.2.7 header UI regression passed while preserving the V15.2.4 icon-alignment asset pin.");
