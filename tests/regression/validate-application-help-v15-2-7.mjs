...
assert.ok(html.includes('<script src="./application-help.js?v=15.2.8-phase5b1"></script>'), "Application Help runtime tag missing");
...
assert.ok(worker.includes('asset("./application-help.js?v=15.2.8-phase5b1")'), "Service worker does not precache Application Help");
...
console.log("Application Help V15.2.8 extraction validation passed.");
