...
assert.ok(html.indexOf("./net-worth.js?v=2.4.0-talaan1") > html.indexOf("./reports-insights.js?v=2.4.0-talaan1"));
assert.match(worker, /net-worth\.js\?v=2\.4\.0-talaan1/);
assert.match(worker, /net-worth\.css\?v=2\.4\.0-talaan1/);
