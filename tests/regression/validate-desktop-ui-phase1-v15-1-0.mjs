...
if (version.cacheVersion !== "finance-v15-20260821-production-audit-r52") fail(`Unexpected cache version: ${version.cacheVersion}`);
if (!worker.includes('const CACHE_VERSION = "finance-v15-20260821-production-audit-r52";')) fail("Service worker cache version is not the V15.2.16 production UI audit cache.");
