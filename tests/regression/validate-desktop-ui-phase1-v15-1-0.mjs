...
if (version.cacheVersion !== "finance-v15-20260820-production-ui-audit-r49") fail(`Unexpected cache version: ${version.cacheVersion}`);
if (!worker.includes('const CACHE_VERSION = "finance-v15-20260820-production-ui-audit-r49";')) fail("Service worker cache version is not the V15.2.13 production UI audit cache.");
