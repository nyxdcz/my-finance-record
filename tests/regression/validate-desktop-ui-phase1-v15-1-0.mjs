...
if (version.cacheVersion !== "finance-v15-20260820-ui-asset-delivery-r45") fail(`Unexpected cache version: ${version.cacheVersion}`);
if (!worker.includes('const CACHE_VERSION = "finance-v15-20260820-ui-asset-delivery-r45";')) fail("Service worker cache version is not the V15.2.9 Application Help extraction cache.");
