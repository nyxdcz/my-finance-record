...
if (version.cacheVersion !== "finance-v15-20260821-monthly-repeat-label-r57") fail(`Unexpected cache version: ${version.cacheVersion}`);
if (!worker.includes('const CACHE_VERSION = "finance-v15-20260821-monthly-repeat-label-r57";')) fail("Service worker cache version is not the V15.2.21 compact expense cards cache.");
