...
if (version.cacheVersion !== "finance-v15-20260821-compact-expense-cards-r55") fail(`Unexpected cache version: ${version.cacheVersion}`);
if (!worker.includes('const CACHE_VERSION = "finance-v15-20260821-compact-expense-cards-r55";')) fail("Service worker cache version is not the V15.2.19 compact expense cards cache.");
...
console.log("Desktop UI Phase 1 validation passed under V15.2.19: neutral Available money section border, desktop hierarchy, compact Income, report export menu, calendar states, Settings disclosure, contextual Paid note, deployment packaging, and preserved phone-Finance/cloud-profile delivery are source-aligned.");