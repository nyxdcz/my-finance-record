...
assert.match(css, /Fine-pointer desktop project headers share the compact 30px control rhythm/);
assert.match(css, /\.project-calendar-v13020 \.pc-header-actions/);
assert.match(css, /#activeProjectsCard \.project-kanban-header-actions/);
