...
assert.match(sw, /finance-v15-20260821-compact-expense-cards-r55/);
assert.match(index, /finance-v15-20260821-compact-expense-cards-r55/);
console.log("V15.2.19 borderless month-navigation regression passed.");
