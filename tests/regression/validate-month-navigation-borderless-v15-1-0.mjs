...
assert.match(sw, /finance-v15-20260821-monthly-repeat-label-r57/);
assert.match(index, /finance-v15-20260821-monthly-repeat-label-r57/);
console.log("V15.2.21 borderless month-navigation regression passed.");
