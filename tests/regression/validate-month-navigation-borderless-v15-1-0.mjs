...
assert.match(sw, /finance-v15-20260819-application-help-r42/);
assert.match(index, /finance-v15-20260819-application-help-r42/);
console.log("V15.2.7 borderless month-navigation regression passed.");
