...
assert.match(sw, /finance-v15-20260821-compact-expense-stability-r56/);
assert.match(index, /finance-v15-20260821-compact-expense-stability-r56/);
console.log("V15.2.20 borderless month-navigation regression passed.");
