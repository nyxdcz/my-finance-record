...
assert.match(sw, /finance-v15-20260821-monthly-repeat-class-r58/);
assert.match(index, /finance-v15-20260821-monthly-repeat-class-r58/);
console.log("V15.2.22 borderless month-navigation regression passed.");
