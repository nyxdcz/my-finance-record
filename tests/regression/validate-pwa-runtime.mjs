...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v2-20260825-payees-rules-r7";/);
...
for (const file of ["pwa-update.js", "phone-finance-compat.js", "header-tools-compat.js", "cash-flow-summary.js"]) {
