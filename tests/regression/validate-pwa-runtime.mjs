...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v2-20260826-import-center-r8";/);
...
for (const file of ["pwa-update.js", "phone-finance-compat.js", "header-tools-compat.js", "cash-flow-summary.js", "import-center.js", "import-center.css"]) {
