...
assert.equal(version.version, "15.2.12");
assert.equal(version.schemaVersion, 12);
assert.equal(version.cloudSchemaVersion, 3);
assert.equal(version.cacheVersion, "finance-v15-20260820-auth-sync-r48");
...
assert.ok(index.includes('const APP_CACHE_VERSION = "finance-v15-20260820-auth-sync-r48";'));
assert.ok(sw.includes("finance-v15-20260820-auth-sync-r48"));
for (const pin of [
  "app.css?v=15.1.0-desktop3",
  "shell-ui-v15-2-11.css?v=15.2.11-shell1",
  "dashboard-interactions.css?v=15.2.10-icons1",
...
console.log("V15.2.12 desktop UI consistency validation passed.");
