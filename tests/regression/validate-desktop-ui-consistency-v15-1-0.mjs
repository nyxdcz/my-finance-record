...
assert.ok(index.includes(`const APP_CACHE_VERSION = "${version.cacheVersion}";`));
...
console.log("Talaan V2.0.1 desktop UI consistency validation passed while preserving compatibility asset pins.");
