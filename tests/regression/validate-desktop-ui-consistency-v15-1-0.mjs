...
assert.ok(index.includes('const APP_CACHE_VERSION = "finance-v15-20260820-structured-project-drag-r51";'));
assert.ok(sw.includes("finance-v15-20260820-structured-project-drag-r51"));
for (const pin of [
  "app.css?v=15.1.0-desktop3",
  "shell-ui-v15-2-11.css?v=15.2.11-shell1",
  "dashboard-interactions.css?v=15.2.10-icons1",
...
console.log("V15.2.15 desktop UI consistency validation passed.");
