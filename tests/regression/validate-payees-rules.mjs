...
assert.match(index, /payees-rules\.js\?v=2\.5\.0-talaan1/);
assert.match(css, /min-height:44px/);
assert.match(css, /@media\(max-width:620px\)/);
assert.match(css, /prefers-reduced-motion/);
assert.match(css, /forced-colors/);
assert.match(worker, /payees-rules\.js\?v=2\.5\.0-talaan1/);
assert.match(worker, /payees-rules\.css\?v=2\.5\.0-talaan1/);
