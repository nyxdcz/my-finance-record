...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260821-monthly-repeat-icon-r59";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260821-monthly-repeat-icon-r59";/);
assert.match(updater, /const UI_HOTFIX_REFRESH_KEY = "finance-ui-hotfix-v15-2-23-monthly-repeat-icon1";/);
...
assert.match(worker, /const APP_VERSION = "15\.2\.23";/);
assert.match(worker, /finance-v15-20260821-monthly-repeat-icon-r59/);
...
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.2\.23-release5/);
...
console.log("V15.2.23 PWA updater regression passed with pure PWA/cache ownership, static sidebar branding, neutral Finance border delivery, and light-mode account-name-only refresh delivery.");
