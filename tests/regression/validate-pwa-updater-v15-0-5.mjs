...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260819-sync-config-separation-r43";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260819-sync-config-separation-r43";/);
...
assert.match(worker, /const APP_VERSION = "15\.2\.7";/);
assert.match(worker, /finance-v15-20260819-sync-config-separation-r43/);
