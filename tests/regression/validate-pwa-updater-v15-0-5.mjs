...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260819-pwa-ui-ownership-r44";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260819-pwa-ui-ownership-r44";/);
...
assert.match(worker, /const APP_VERSION = "15\.2\.8";/);
assert.match(worker, /finance-v15-20260819-pwa-ui-ownership-r44/);
...
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.2\.8-release1/);
...
console.log("V15.2.8 PWA updater regression passed with Application Help extraction cache refresh.");
