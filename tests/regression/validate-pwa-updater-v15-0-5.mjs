...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260820-ui-asset-delivery-r45";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260820-ui-asset-delivery-r45";/);
...
assert.match(worker, /const APP_VERSION = "15\.2\.9";/);
assert.match(worker, /finance-v15-20260820-ui-asset-delivery-r45/);
...
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.2\.9-release1/);
...
console.log("V15.2.9 PWA updater regression passed with Application Help extraction cache refresh.");
