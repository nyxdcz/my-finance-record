...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260820-auth-sync-r48";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260820-auth-sync-r48";/);
...
assert.match(worker, /const APP_VERSION = "15\.2\.12";/);
assert.match(worker, /finance-v15-20260820-auth-sync-r48/);
...
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.2\.12-release8/);
...
console.log("V15.2.12 PWA updater regression passed with pure PWA/cache ownership and static sidebar branding.");
