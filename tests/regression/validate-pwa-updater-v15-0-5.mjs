...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260821-monthly-repeat-label-r57";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260821-monthly-repeat-label-r57";/);
assert.match(updater, /const UI_HOTFIX_REFRESH_KEY = "finance-ui-hotfix-v15-2-21-monthly-repeat1";/);
...
assert.match(worker, /const APP_VERSION = "15\.2\.21";/);
assert.match(worker, /finance-v15-20260821-monthly-repeat-label-r57/);
...
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.2\.21-release3/);
...
console.log("V15.2.21 PWA updater regression passed with pure PWA/cache ownership, static sidebar branding, neutral Finance border delivery, and light-mode account-name-only refresh delivery.");
