...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260820-shell-ui-r47";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260820-shell-ui-r47";/);
...
assert.match(worker, /const APP_VERSION = "15\.2\.11";/);
assert.match(worker, /finance-v15-20260820-shell-ui-r47/);
...
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.2\.11-release7/);
...
console.log("V15.2.11 PWA updater regression passed with pure PWA/cache ownership and static sidebar branding.");
