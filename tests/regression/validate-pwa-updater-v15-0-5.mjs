...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260819-application-help-r42";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260819-application-help-r42";/);
...
assert.match(worker, /finance-v15-20260819-application-help-r42/);
