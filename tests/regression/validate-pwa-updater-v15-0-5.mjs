...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260820-common-desktop-r50";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260820-common-desktop-r50";/);
...
assert.match(worker, /const APP_VERSION = "15\.2\.14";/);
assert.match(worker, /finance-v15-20260820-common-desktop-r50/);
...
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.2\.14-release10/);
...
console.log("V15.2.14 PWA updater regression passed with pure PWA/cache ownership and static sidebar branding.");
