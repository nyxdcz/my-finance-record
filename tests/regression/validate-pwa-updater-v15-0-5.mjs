...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260822-compact-expense-collapse-r60";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260822-compact-expense-collapse-r60";/);
assert.match(updater, /const UI_HOTFIX_REFRESH_KEY = "finance-ui-hotfix-v15-2-24-compact-expense-collapse1";/);
...
assert.match(updater, /production-ui-audit-v15-2-13\.css/);
assert.match(updater, /phone-finance-compat\.js/);
...
assert.match(index, /phone-finance-compat\.js\?v=15\.2\.24-compact1/, "Index must load the refreshed Phone Finance compatibility entry");
assert.match(worker, /phone-finance-compat\.js\?v=15\.2\.24-compact1/, "Service worker must precache the refreshed Phone Finance compatibility entry");
...
assert.match(worker, /const APP_VERSION = "15\.2\.24";/);
assert.match(worker, /finance-v15-20260822-compact-expense-collapse-r60/);
...
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.2\.24-release1/);
...
console.log("V15.2.24 PWA updater regression passed with compact-expense cache delivery and existing compatibility ownership preserved.");
