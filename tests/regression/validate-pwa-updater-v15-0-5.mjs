...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v2-20260822-organized-complete-r1";/);
assert.match(updater, /const UI_HOTFIX_REFRESH_KEY = "finance-ui-hotfix-v2-0-0-organized1";/);
...
assert.match(index, /phone-finance-compat\.js\?v=2\.0\.0-organized1/, "Index must load the V2 Phone Finance compatibility entry");
assert.match(worker, /phone-finance-compat\.js\?v=2\.0\.0-organized1/, "Service worker must precache the V2 Phone Finance compatibility entry");
...
assert.match(worker, /pwa-update-v15-0-5\.js\?v=2\.0\.0-release1/);
...
console.log("V2.0.0 PWA updater regression passed with organized cache delivery and legacy compatibility ownership preserved.");
