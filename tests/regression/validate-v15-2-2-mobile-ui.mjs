...
assert.match(index, /My Finance Records · V15\.2\.21/);
assert.match(index, /mobile-v14-0-23\.css\?v=15\.2\.10-mobile2/);
assert.match(index, /sync-config\.js\?v=15\.2\.10-release1/);
assert.match(index, /const APP_VERSION = "15\.2\.21";/);
assert.match(sw, /const APP_VERSION = "15\.2\.21";/);
...
assert.match(runtimeCompat, /const VERSION = "15\.2\.21";/);
assert.match(runtimeCompat, /const RELEASE_NAME = "Visible Monthly Recurrence";/);
