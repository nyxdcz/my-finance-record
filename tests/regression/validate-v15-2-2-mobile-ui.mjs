...
assert.match(index, /My Finance Records · V2\.0\.0/);
assert.match(index, /mobile-v14-0-23\.css\?v=15\.2\.10-mobile2/);
assert.match(index, /sync-config\.js\?v=15\.2\.10-release1/);
assert.match(index, /const APP_VERSION = "2\.0\.0";/);
assert.match(sw, /const APP_VERSION = "2\.0\.0";/);
...
assert.match(runtimeCompat, /const VERSION = "2\.0\.0";/);
assert.match(runtimeCompat, /const RELEASE_NAME = "Organized Complete";/);
...
console.log("V2.0.0 preserves the proven V15.2.2 mobile UI/UX contract with static CSS and dedicated Phone Finance JS ownership.");
