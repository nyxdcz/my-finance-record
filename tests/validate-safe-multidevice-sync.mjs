...
assert(worker.includes('finance-v15-20260817-phone-finance-r37'), "PWA cache was not rotated for the V15.2.2 phone-Finance/cloud-profile refresh");
assert(worker.includes('asset("./cloud-sync.js?v=15.2.1-ux1")'), "PWA shell does not pin the V15.2.1 cloud sync client");
