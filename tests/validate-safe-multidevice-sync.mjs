...
assert(worker.includes('finance-v15-20260815-month-nav-borderless-r23'), "PWA cache was not rotated for the current V15.0.4 shell");
assert(worker.includes('asset("./cloud-sync.js?v=15.1.0")'), "PWA shell does not pin the repaired cloud sync client");
