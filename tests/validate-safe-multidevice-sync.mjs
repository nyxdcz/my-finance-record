...
assert(worker.includes('finance-v15-20260815-ui-align-r11'), "PWA cache was not rotated for the current V15.0.4 shell");
assert(worker.includes('asset("./cloud-sync.js?v=15.0.4")'), "PWA shell does not pin the repaired cloud sync client");
