...
assert(worker.includes('finance-v15-20260815-liquid-glass-r6'), "PWA cache generation is not current for V15.0.0");
...
assert(worker.includes('asset("./cloud-sync.js?v=15.0.2")'), "V15 cloud sync asset is missing from the offline shell");
