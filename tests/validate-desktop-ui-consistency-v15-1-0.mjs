...
assert.ok(index.includes('const APP_CACHE_VERSION = "finance-v15-20260816-desktop-ux-quick-wins-r30";'));
assert.ok(sw.includes("finance-v15-20260816-desktop-ux-quick-wins-r30"));
for (const pin of [
  "app.css?v=15.1.0-desktop3",
  "dashboard-interactions.css?v=15.1.0-desktop3",
  "security-profiles.css?v=15.1.0-desktop2",
