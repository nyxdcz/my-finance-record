...
for (const pin of [
  ...
  "sync-config.js?v=15.2.1-ux1"
]) assert.ok(index.includes(pin), `index missing ${pin}`);
assert.ok(index.includes('const APP_CACHE_VERSION = "finance-v15-20260816-desktop-ux-quick-wins-r31";'));
assert.ok(sw.includes("finance-v15-20260816-desktop-ux-quick-wins-r31"));
for (const pin of [
  "app.css?v=15.1.0-desktop3",
  "dashboard-interactions.css?v=15.1.0-desktop3",
  "security-profiles.css?v=15.1.0-desktop2",
  ...
  "black-canvas-v15-1-0.css?v=15.1.0-light1",
  "sync-config.js?v=15.2.1-ux1",
  "liquid-glass-v15.css?v=15.2.1-light1"
