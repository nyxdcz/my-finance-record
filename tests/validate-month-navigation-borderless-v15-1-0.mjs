...
assert.equal(version.cacheVersion, "finance-v15-20260817-phone-finance-r36");
...
assert.match(sw, /finance-v15-20260817-phone-finance-r36/);
assert.match(index, /finance-v15-20260816-mobile-ui-ux-r32/);
console.log("V15.2.2 borderless month-navigation regression passed.");
