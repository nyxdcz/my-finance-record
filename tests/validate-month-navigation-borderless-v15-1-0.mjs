...
assert.equal(version.version, "15.2.4");
assert.equal(version.schemaVersion, 12);
assert.equal(version.cloudSchemaVersion, 3);
assert.equal(version.cacheVersion, "finance-v15-20260818-ui-refinement-r39");
...
assert.match(sw, /finance-v15-20260818-ui-refinement-r39/);
assert.match(index, /finance-v15-20260818-ui-refinement-r39/);
console.log("V15.2.4 borderless month-navigation regression passed.");
