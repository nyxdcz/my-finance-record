...
assert.match(sw, /liquid-glass-v15\.css\?v=15\.1\.0-light1/);
assert.match(sw, /finance-v15-20260815-desktop-consistency-r27/);
assert.match(index, /finance-v15-20260815-desktop-consistency-r27/);
