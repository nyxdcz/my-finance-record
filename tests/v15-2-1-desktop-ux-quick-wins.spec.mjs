...
test("V15.2.1 source keeps the approved desktop UX quick wins", async () => {
  ...
  expect(index).toContain("V15.2.5");
  ...
  expect(version.cacheVersion).toBe("finance-v15-20260818-disclosure-alignment-r40");
  expect(sw).toContain('const APP_VERSION = "15.2.5";');
  expect(sw).toContain('finance-v15-20260818-disclosure-alignment-r40');
});
