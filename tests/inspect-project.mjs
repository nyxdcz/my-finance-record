...
const requiredFiles = [
  "index.html", "app.css", "dashboard-interactions.css", "interaction-patterns.js", "offline.html", "manifest.webmanifest", "version.json", "sw.js",
  ...
  "Install_V14_0_21.command", "run_audit.sh", "eslint.config.js", "playwright.config.mjs",
  "tests/validate-v14-0-21.mjs", "tests/privacy-and-inputs.spec.mjs", "tests/check-maintainability.mjs"
];
...
if (pkg.version !== "14.0.21") fail(`Expected current package version 14.0.21, found ${pkg.version || "(missing)"}`);
if (!read("README.md").startsWith("# My Finance Records · V14.0.21")) fail("README release heading is not V14.0.21");
...
if (process.platform !== "win32") {
  for (const file of ["Install_V14_0_21.command", "run_audit.sh"]) {
