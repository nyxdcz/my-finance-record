...
if (pkg.version !== "15.2.2") fail(`Expected current package version 15.2.2, found ${pkg.version || "(missing)"}`);
if (!read("README.md").startsWith("# My Finance Records · V15.2.2")) fail("README release heading is not V15.2.2");
if (!read("CHANGELOG.md").startsWith("## 15.2.2 · 2026-08-16")) fail("CHANGELOG latest entry is not V15.2.2");
...
console.log("Repository inspection passed: V15.2.2 release files, local paths, deploy paths, package metadata, permissions, and public sync configuration are consistent.");
