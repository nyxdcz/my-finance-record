...
if (pkg.version !== "15.2.3") fail(`Expected current package version 15.2.3, found ${pkg.version || "(missing)"}`);
if (!read("README.md").startsWith("# My Finance Records · V15.2.3")) fail("README release heading is not V15.2.3");
if (!read("CHANGELOG.md").startsWith("## 15.2.3 · 2026-08-17")) fail("CHANGELOG latest entry is not V15.2.3");
...
console.log("Repository inspection passed: V15.2.3 release files, local paths, deploy paths, package metadata, permissions, and public sync configuration are consistent.");
