...
const requiredFiles = [
  ...
  "sync-config.js", "sync-config.example.js", "privacy-lock.js", "cloud-conflict-review.js", "projects-calendar-v13.0.20.js", "projects-calendar-v13.0.20.css",
  "Install_V14_0_6.command", "run_audit.sh", "eslint.config.js", "playwright.config.mjs",
  "tests/validate-v14-0-6.mjs", "tests/privacy-and-inputs.spec.mjs", "tests/check-maintainability.mjs"
];
...
if (pkg.version !== "14.0.6") fail(`Expected current package version 14.0.6, found ${pkg.version || "(missing)"}`);
if (!read("README.md").startsWith("# My Finance Records · V14.0.6 PWA")) fail("README release heading is not V14.0.6");
...
if (process.platform !== "win32") {
  for (const file of ["Install_V14_0_6.command", "run_audit.sh"]) {
