...
if (pkg.version !== "15.2.5") fail(`Expected current package version 15.2.5, found ${pkg.version || "(missing)"}`);
if (!read("README.md").startsWith("# My Finance Records · V15.2.6")) fail("README release heading is not V15.2.5");
if (!read("CHANGELOG.md").startsWith("## 15.2.6 · 2026-08-19")) fail("CHANGELOG latest entry is not V15.2.5");
