...
const required = [
  ...
  [pkg.version === "15.2.3", "package.json is V15.2.4"],
  [version.schemaVersion === 12 && version.cloudSchemaVersion === 3, "schemas remain 12/3"],
  [version.cacheVersion === "finance-v15-20260818-ui-refinement-r39", "sync-status refresh cache is declared"],
  ...
  [read("sync-config.js").includes('const VERSION = "15.2.3"') && read("sync-config.js").includes('const RELEASE_NAME = "Sync Status Icons"'), "release override matches V15.2.4"],
