...
async function installSidebarFixture(page, extraSidebarClass = "") {
  ...
  await page.addStyleTag({ url:"http://127.0.0.1:3000/app.css?v=2.4.0-talaan1" });
  await page.addStyleTag({ url:"http://127.0.0.1:3000/shell-ui.css?v=2.4.0-talaan1" });
  await page.addStyleTag({ url:"http://127.0.0.1:3000/sidebar-compact-brand.css?v=2.2.0-talaan2" });
  await page.addStyleTag({ url:"http://127.0.0.1:3000/assets/css/ui-icon-alignment.css?v=2.4.0-talaan1" });
}
...
test("runtime preparation renders fresh real brand assets without changing release identity", () => {
  ...
  expect(updater).toContain('const CURRENT_CACHE_VERSION = "finance-v2-20260827-net-worth-r10"');
