...
test("desktop Budget & Expenses uses the approved supplied mascots and exact spacing", async ({ page }) => {
  ...
  for (const image of imageLoads) {
    ...
    expect(image.src).toContain("?v=2.2.0-talaan1");
  ...
  const expected = {
    legendEarlyTotal:["red", "mascot-red.png?v=2.2.0-talaan1"],
    legendLateTotal:["orange", "mascot-orange.png?v=2.2.0-talaan1"],
    legendOtherTotal:["blue", "mascot-blue.png?v=2.2.0-talaan1"],
    earlyTotal:["red", "mascot-red.png?v=2.2.0-talaan1"],
    lateTotal:["orange", "mascot-orange.png?v=2.2.0-talaan1"],
    otherTotal:["blue", "mascot-blue.png?v=2.2.0-talaan1"]
  };
...
test("difference cards follow green and red state while phone disables mascot override", async ({ page }) => {
  ...
  expect(positive.background).toContain("mascot-green.png?v=2.2.0-talaan1");
  ...
  expect(negative.background).toContain("mascot-red.png?v=2.2.0-talaan1");
