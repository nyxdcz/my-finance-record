...
for (const theme of ["light", "dark"]) {
  test(`Talaan V2.4.0 appearance uses the expected ${theme} palette`, async ({ page }) => {
    ...
    await page.setContent(`<!doctype html><html data-theme="${theme}"><head>
      ...
      <link rel="stylesheet" href="http://127.0.0.1:3000/desktop-ui-phase1.css?v=2.4.0-talaan1">
      <link rel="stylesheet" href="http://127.0.0.1:3000/desktop-ux.css?v=2.4.0-talaan1">
      <link rel="stylesheet" href="http://127.0.0.1:3000/production-ui-audit.css?v=2.4.0-talaan1">
