...
test("V15.2.1 source keeps the approved desktop UX quick wins", async () => {
  ...
  expect(version.version).toBe("15.2.12");
  expect(version.schemaVersion).toBe(12);
  expect(version.cloudSchemaVersion).toBe(3);
  expect(version.cacheVersion).toBe("finance-v15-20260820-auth-sync-r48");
  expect(sw).toContain('const APP_VERSION = "15.2.12";');
  expect(sw).toContain('finance-v15-20260820-auth-sync-r48');
});
