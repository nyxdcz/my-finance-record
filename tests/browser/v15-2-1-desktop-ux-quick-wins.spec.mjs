...
test("V15.2.1 source keeps the approved desktop UX quick wins", async () => {
  ...
  expect(index).toContain("V15.2.8");
  ...
  expect(version.version).toBe("15.2.8");
  expect(version.schemaVersion).toBe(12);
  expect(version.cloudSchemaVersion).toBe(3);
  expect(version.cacheVersion).toBe("finance-v15-20260819-pwa-ui-ownership-r44");
  expect(sw).toContain('const APP_VERSION = "15.2.8";');
  expect(sw).toContain('finance-v15-20260819-pwa-ui-ownership-r44');
});
