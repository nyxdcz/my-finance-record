...
const css = [
  ...
  "productivity-tools.css?v=2.2.0-talaan1",
...
for (const width of widths) {
  test(`Talaan V2.2.0 phone geometry is safe at ${width}px`, async ({ page }) => {
...
test("Talaan V2.2.0 short landscape phones retain touch-safe controls", async ({ page }) => {
...
test("Talaan V2.2.0 short portrait keeps the dialog within the dynamic viewport", async ({ page }) => {
...
test("Talaan V2.2.0 mobile stylesheet does not change the 1024px desktop workspace contract", async ({ page }) => {
