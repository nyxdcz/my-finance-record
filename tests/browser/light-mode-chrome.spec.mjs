...
for (const theme of ["light","dark"]) {
  test(`Talaan V2.0.1 ${theme} final chrome is readable`, async ({ page }) => {
    ...
    await page.setContent(`<!doctype html><html data-theme="${theme}"><head>
      ...
      <link rel="stylesheet" href="http://127.0.0.1:3000/dashboard-interactions.css?v=2.0.1-talaan3">
      <link rel="stylesheet" href="http://127.0.0.1:3000/black-canvas.css?v=2.0.1-talaan3">
      <link rel="stylesheet" href="http://127.0.0.1:3000/liquid-glass.css?v=2.0.1-talaan3">
