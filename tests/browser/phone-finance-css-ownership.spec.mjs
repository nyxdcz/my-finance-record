...
test("live Talaan V2.0.1 shell owns Phone Finance compact styles statically", async ({ page }) => {
  ...
  expect(delivery.styles.some(href => href.includes("mobile.css?v=2.0.1-talaan5"))).toBe(true);
