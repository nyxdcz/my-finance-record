...
test("live Talaan V2.1.0 shell owns Phone Finance compact styles statically", async ({ page }) => {
  ...
  expect(delivery.styles.some(href => href.includes("mobile.css?v=2.1.0-talaan1"))).toBe(true);
  expect(delivery.scripts.some(src => src.includes("pwa-update.js?v=2.1.0-talaan1"))).toBe(true);
});
