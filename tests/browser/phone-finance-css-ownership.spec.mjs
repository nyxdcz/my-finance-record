...
test("live Talaan V2.3.0 shell owns Phone Finance compact styles statically", async ({ page }) => {
  ...
  expect(delivery.styles.some(href => href.includes("mobile.css?v=2.3.0-talaan1"))).toBe(true);
