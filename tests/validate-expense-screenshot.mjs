...
assert.match(worker, /finance-v15-20260815-black-canvas-r15/, "service worker cache generation must remain current for V15 while preserving screenshot detection");
