...
assert.match(worker, /finance-v15-20260815-finance-marquee-r24/, "service worker cache generation must remain current for V15 while preserving screenshot detection");
