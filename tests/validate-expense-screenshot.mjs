...
assert.match(worker, /finance-v15-20260815-month-nav-borderless-r23/, "service worker cache generation must remain current for V15 while preserving screenshot detection");
