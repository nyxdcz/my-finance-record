...
assert.match(worker, /finance-v15-20260816-cashflow-r33/, "service worker cache generation must remain current for V15.2.2 while preserving screenshot detection");
