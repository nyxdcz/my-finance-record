...
assert.match(worker, /finance-v15-20260816-desktop-ux-quick-wins-r30/, "service worker cache generation must remain current for V15.2.1 while preserving screenshot detection");
