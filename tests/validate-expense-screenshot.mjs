...
assert.match(worker, /finance-v15-20260815-pwa-update-r13/, "service worker cache generation must remain current for V15 while preserving screenshot detection");
