...
for(const token of ['height:43px; min-height:43px; max-height:43px','finance-workspace-marquee-row','> .money-workspace-switcher { position:static','> .finance-week-marquee { flex:1 1 auto','.dashboard-week-marquee { display:none!important; }']) assert(css.includes(token),`V14.0.22 marquee layout safeguard missing: ${token}`);
