...
test("V15.2.3 registers the cache-qualified worker and clears stale Finance caches", async ({ page }) => {
  ...
  expect(workerUrl).toContain("cache=finance-v15-20260817-sync-status-r38");
