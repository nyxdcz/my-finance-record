...
test("V15.1.0 registers the cache-qualified worker and clears stale Finance caches", async ({ page }) => {
  ...
  expect(workerUrl).toContain("cache=finance-v15-20260815-month-nav-borderless-r23");
