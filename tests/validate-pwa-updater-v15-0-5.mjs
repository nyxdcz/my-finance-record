...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260816-desktop-ux-r29";/);
...
assert.match(worker, /const APP_VERSION = "15\.2\.0";/);
assert.match(worker, /finance-v15-20260816-desktop-ux-r29/);
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.1\.0/);
assert.match(worker, /ui-icon-alignment-v15-0-5\.css\?v=15\.1\.0-ui3/);
console.log("V15.2.0 PWA updater regression passed.");
