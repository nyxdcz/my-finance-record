...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260818-disclosure-alignment-r40";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260818-disclosure-alignment-r40";/);
...
assert.match(worker, /const APP_VERSION = "15\.2\.5";/);
assert.match(worker, /finance-v15-20260818-disclosure-alignment-r40/);
...
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.2\.5-release1/);
assert.match(worker, /ui-icon-alignment-v15-0-5\.css\?v=15\.2\.4-ui1/);
console.log("V15.2.5 PWA updater regression passed with disclosure-alignment cache refresh.");
