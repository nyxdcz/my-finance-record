...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260817-phone-finance-r36";/);
...
assert.match(worker, /finance-v15-20260817-phone-finance-r36/);
...
console.log("V15.2.2 PWA updater regression passed with phone-Finance cache refresh.");
