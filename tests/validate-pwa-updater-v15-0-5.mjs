...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260816-desktop-ux-quick-wins-r31";/);
...
assert.match(worker, /finance-v15-20260816-desktop-ux-quick-wins-r31/);
