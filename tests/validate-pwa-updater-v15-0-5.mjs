...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260816-mobile-ui-ux-r32";/);
...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260816-import-review-r34";/);
...
assert.match(worker, /const APP_VERSION = "15\.2\.2";/);
assert.match(worker, /finance-v15-20260816-import-review-r34/);
assert.match(worker, /networkFirstCriticalAsset/);
assert.match(worker, /url\.pathname\.endsWith\("privacy-lock\.js"\)/);
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.1\.0/);
assert.match(worker, /ui-icon-alignment-v15-0-5\.css\?v=15\.1\.0-ui3/);
console.log("V15.2.2 PWA updater regression passed with recovery import cache refresh.");
