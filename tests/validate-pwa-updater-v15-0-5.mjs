...
assert.match(index, /const APP_CACHE_VERSION = "finance-v15-20260815-header-ui-r14";/);
...
assert.match(worker, /finance-v15-20260815-header-ui-r14/);
assert.match(worker, /pwa-update-v15-0-5\.js\?v=15\.0\.5/);
assert.match(worker, /ui-icon-alignment-v15-0-5\.css\?v=15\.0\.5-ui2/);
