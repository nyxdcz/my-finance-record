...
assert.match(updater, /const CURRENT_CACHE_VERSION = "finance-v15-20260816-sidebar-brand-r35";/);
...
assert.match(worker, /finance-v15-20260816-sidebar-brand-r35/);
...
console.log("V15.2.2 PWA updater regression passed with sidebar-brand cache refresh.");
