...
assert.match(updater, /const LEGACY_INDEX_CACHE = "finance-v15-20260817-sync-status-r38";/);
...
console.log("V15.2.2 PWA updater regression passed with phone-Finance/cloud-profile cache refresh.");
